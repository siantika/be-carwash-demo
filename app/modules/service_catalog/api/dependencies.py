...
def get_list_service_types_usecase(
    service_type_query: Annotated[
        PostgresServiceTypeQueryRepository, Depends(get_service_type_query)
    ],
):
    return ListServiceTypesUseCase(service_type_query)


def get_find_service_type_by_id(
    service_type_repo: Annotated[AsyncPgServiceTypeRepository, Depends(get_service_type_repo)],
):
    return FindServiceTypeByIdUseCase(service_type_repo)


def get_find_service_type_by_name(
    service_type_repo: Annotated[AsyncPgServiceTypeRepository, Depends(get_service_type_repo)],
):
    return FindServiceTypeByNameUseCase(service_type_repo)


def get_create_service_type_usecase(
    service_type_repo: Annotated[AsyncPgServiceTypeRepository, Depends(get_service_type_repo)],
):
    return CreateServiceTypeUseCase(service_type_repo)


def get_change_service_type_usecase(
    service_type_repo: Annotated[AsyncPgServiceTypeRepository, Depends(get_service_type_repo)],
):
    return ChangeServiceTypeDataUseCase(service_type_repo)


def get_activate_service_type_usecase(
    service_type_repo: Annotated[AsyncPgServiceTypeRepository, Depends(get_service_type_repo)],
):
...
def get_delete_service_type_usecase(
    service_type_repo: Annotated[AsyncPgServiceTypeRepository, Depends(get_service_type_repo)],
):
